...
class BlobManagerTest {
    ...
    void setUp() {
        ...
        sasToken = tokenGeneratorService.generateSasToken(PROCESSED_CONTAINER);
    }
    ...
    void retrieves_blob_client() {
        ...
        BlobClient actualClient = blobManager.getBlobClient(PROCESSED_CONTAINER, sasToken, BLOB_NAME);
